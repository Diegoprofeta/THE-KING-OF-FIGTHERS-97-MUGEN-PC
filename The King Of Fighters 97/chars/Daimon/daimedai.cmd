...
triggerall = numhelper(4805) <= 0 && power >= 2000
triggerall = var(40) <= 0
...
triggerall = numhelper(4705) <= 0 && power >= 2000
triggerall = var(40) <= 0
trigger1 = (stateno = [0,12]) && ctrl
...
triggerall = power < 2000 && var(40) <= 0 && var(37) <= 0
trigger1 = ctrl
...
trigger1 = random <= 700 && power < 2000 && var(40) <= 0
