...
triggerall = p2movetype = A;access only when opponent attack
triggerall = P2bodydist X = [0,25];access only when near
triggerall = random <= 500;high percent
triggerall = statetype != A;perform when not in air
triggerall = var(9) = 1;only AI can access
triggerall = ctrl
...
triggerall = enemynear, hitdefattr != , NT, ST, HT
triggerall = p2movetype = A;access only when opponent attack
triggerall = P2bodydist X >= 150;access only when near
...
triggerall = p2stateno != 5120;player is not in getup state
triggerall = random < 1000
triggerall = P2bodydist X <= 30;access only when near
triggerall = p2stateno != 130
triggerall = p2stateno != 131
trigger1 = p2movetype != H 
trigger1 = ctrl
...
triggerall = P2bodydist X = [45,80];access only when near
trigger1 = ctrl
trigger2 = stateno = 215
trigger2 = movecontact
trigger3 = stateno = 250
...
triggerall = p2stateno != 5120;player is not in getup state
triggerall = random < 200
triggerall = P2bodydist X = [50,80];access only when near
trigger1 = ctrl
trigger2 = stateno = 215
trigger2 = movecontact
trigger3 = stateno = 250
...
triggerall = P2bodydist X = [40,80];access only when near
trigger1 = ctrl
trigger2 = stateno = 215
trigger2 = movecontact
trigger3 = stateno = 250
...
triggerall = p2stateno != 5120;player is not in getup state
triggerall = random < 1000
triggerall = P2bodydist X = [0,70];access only when near
triggerall = var(9) = 1
triggerall = power >= 1000
triggerall = life <= 200
triggerall = Var(10) > 0
...
triggerall = p2stateno != 5120;player is not in getup state
triggerall = random < 500
triggerall = P2bodydist X = [40,70];access only when near
trigger1 = ctrl
trigger2 = stateno = 215
trigger2 = movecontact
trigger3 = stateno = 250
...
triggerall = P2bodydist X >= 70;access only when near
triggerall = p2stateno != 130
triggerall = p2stateno != 131
trigger1 = ctrl
trigger2 = stateno = 215
...
triggerall = p2statetype != L
triggerall = p2statetype != A
triggerall = P2bodydist X = [1,20];access only when near
...
triggerall = var(9) = 1
triggerall = power < 3000
triggerall = random <= 700 && p2bodydist x >= 90
triggerall = stateno = 0
trigger1 = p2stateno = [5050,5092]
trigger1 = ctrl
trigger2 = p2stateno = [3402,3406]
trigger2 = ctrl
...
triggerall = var(9) = 1
triggerall = statetype != A
triggerall = random <= 300 && p2bodydist x <= 50
...
type = ChangeState
value = 260
triggerall = enemy, hitdefattr != ,NT, ST, HT
triggerall = p2statetype != L 
triggerall = var(9) = 1
...
value = 105
triggerall = var(9) = 1
triggerall = random <= 300 && p2bodydist x <= 20
triggerall = p2statetype = L
