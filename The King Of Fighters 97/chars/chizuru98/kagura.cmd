...
[Command]
name = "yagball"
command = ~D,B,$D,F,x  ;D, F, D, F, x
time = 25

[Command]
name = "yagball"
command = ~D,B,$D,F,y  ;D, F, D, F, y
time = 25
;=============================[Special Moves]=======================================
[Command]
name = "mirrorball1"
...
trigger1 = random <= 300;high percent
trigger1 = statetype = S
trigger2 = random <= 700;high percent
...
triggerall = statetype != A
triggerall = P2bodydist X = [10,40]
triggerall = random <= 900;high percent
trigger1 = p2statetype = A
trigger1 = ctrl
...
triggerall = random <= 800;high percent
triggerall = p2movetype != A 
triggerall = statetype != A
trigger1 = ctrl
;trigger2 = ctrl
